...
public:
	...
	void InitializeReticle(AGameplayAbilityTargetActor* InTargetingActor, AController* PlayerController, FWorldReticleParameters InParameters);
...
protected:
	...
	/** This is used in the process of determining whether we should replicate to a specific client. */
	UPROPERTY(BlueprintReadOnly, Category = "Network")
	TObjectPtr<AController> PrimaryPC;
